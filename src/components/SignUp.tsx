      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        >
          <svg
            ...
            viewBox="0 0 48 48"
          >
            <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.5 33.4 29.1 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.7 3l5.7-5.7C33.5 6.6 28.1 4 22 4 10.9 4 2 12.9 2 24s8.9 20 20 20c11 0 20-8.9 20-20 0-1.3-.1-2.5-.4-3.5z" />
            <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.3 16 18.8 13 24 13c3 0 5.7 1.1 7.7 3l5.7-5.7C33.5 6.6 28.1 4 22 4 14.1 4 7.3 8.8 6.3 14.7z" />
            <path fill="#4CAF50" d="M24 44c6 0 11.3-2.2 15.3-5.9l-7.1-5.8C29.4 34.9 26.8 36 24 36c-5.1 0-9.4-2.6-11.8-6.5l-6.8 5.3C8.7 39.1 15.9 44 24 44z" />
            <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.9 3.9-6.2 6.5-11.3 6.5-3.3 0-6.3-1.3-8.5-3.4l-6.8 5.3C11.6 41.2 17.4 44 24 44c11 0 20-8.9 20-20 0-1.3-.1-2.5-.4-3.5z" />
          </svg>
