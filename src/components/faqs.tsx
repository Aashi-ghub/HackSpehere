  ...
  const faqs = [
    {
      ...
      answer:
        "Xception is an innovative 2-day event provides a unique hybrid experience that guarantees comprehensive student development, making learning truly exceptional.  ",
    },
    {
